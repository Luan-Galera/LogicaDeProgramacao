...
// console.log(numeros[2]); //imprimindo o item de indice 1
...
console.table(dinos); // Imprimindos os dados em forma de tabela
...
//Alterando elementos com base em seu indíce
